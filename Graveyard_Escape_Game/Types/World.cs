    ...
    public class World
    {
        ...
        public World()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                Entities.Add(new Entity<EntityRenderer>(entityVertexData) { Position = new System.Numerics.Vector2(x, y), Scale=0.5f, Velocity = new System.Numerics.Vector2(vx, vy), Colour = new System.Numerics.Vector4(r, g, b, 1.0f) });
            }
        }
