    ...
    public class World
    {
        ...
        public World()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                Entities.Add(new Entity<EntityRenderer>(entityVertexData) { Position = new System.Numerics.Vector2(x, y), Scale=0.1f, Velocity = new System.Numerics.Vector2(vx, vy), Colour = new System.Numerics.Vector4(r, g, b, 1.0f) });
            }
        }
